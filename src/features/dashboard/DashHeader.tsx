...
function DashHeader() {
  ...
  return (
    <motion.section
      ...
      className="bg-card rounded-xl shadow-sm p-3 sm:p-5 md:p-6 flex justify-between flex-col sm:flex-row items-start sm:items-center gap-4 border border-default"
